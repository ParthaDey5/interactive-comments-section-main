...
function CommentCard({IconPlus, IconMinus, IconReply, score, username, createdAt, replyBox, comment, vote, setScore, setVote, avatar}) {
  return (
    <>
    <div className="w-full flex gap-[1.5dvw] px-[1.5dvw] py-[1.8dvw] bg-white100 rounded-[0.7vw]">
            ...
            <div className="flex flex-col gap-[0.8vw]">
              <div className="flex justify-between w-full h-[4dvw">
                ...
                <p className="pointer text-purple600 font-medium flex items-center gap-[0.5dvw] w-fit group hover:text-purple200" onClick={replyBox}>
